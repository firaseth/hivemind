...
Generated by HiveMind Swarm Orchestrator.
    ...
    const mailtoUrl = `mailto:?subject=${encodeURIComponent(reportTitle)}&body=${encodeURIComponent(reportBody)}`;
    ...
    try {
      ...
      alert('Failed to open email client. Report has been copied to clipboard instead.');
    }
  };
      ...
      <div className="hivechat-header">
        ...
        <div className="hivechat-header-right">
          ...
          <button 
            ...
            title="Send full report by email"
          >
            ✉️ Report
          </button>
        </div>
